...
<template>
  <div class="mx-auto min-h-screen space-y-10 text-center dark:bg-gray-800 md:flex">
      <div class="bg-white flex flex-col gap-5 fixed top-0 w-100 py-2 dark:bg-gray-800 dark:text-white">
        <div class="flex justify-between">
          <h1 class="text-xl font-bold mx-auto">Lotion</h1>
          <button @click="theme.toggleTheme">
            <svg v-if="theme.isDark" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-moon-fill" viewBox="0 0 16 16">
              <path d="M6 .278a.77.77 0 0 1 .08.858 7.2 7.2 0 0 0-.878 3.46c0 4.021 3.278 7.277 7.318 7.277q.792-.001 1.533-.16a.79.79 0 0 1 .81.316.73.73 0 0 1-.031.893A8.35 8.35 0 0 1 8.344 16C3.734 16 0 12.286 0 7.71 0 4.266 2.114 1.312 5.124.06A.75.75 0 0 1 6 .278"/>
            </svg>

            <svg v-else xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-sun" viewBox="0 0 16 16">
    ...
    <div class="bg-white p-3 sticky bottom-0 w-100 dark:bg-gray-800 mx-auto xl:top-0 xl:fixed xl:right-0">
